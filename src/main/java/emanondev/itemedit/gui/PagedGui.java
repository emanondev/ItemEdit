...
public interface PagedGui extends Gui {
    ...
    default ItemStack getPreviousPageItem() {
        ...
        this.loadLanguageDescription(meta, "gui.previous-page.description", "%page%", String.valueOf(getPage()), "%target_page%",
    ...
    default ItemStack getNextPageItem() {
        ...
        ItemMeta meta = item.getItemMeta();
        this.loadLanguageDescription(meta, "gui.next-page.description", "%page%", String.valueOf(getPage()), "%target_page%",
                String.valueOf(getPage() + 1));
        item.setItemMeta(meta);
        return item;
    }
